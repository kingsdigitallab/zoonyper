...
TODO: Describe reporting of incident.
...
This code of conduct is based on the Code of Conduct created by the Alan Turing Institute's Open Research Community Building Team, which can be found in the [Template for setting up reproducible projects]([url](https://github.com/alan-turing-institute/reproducible-project-template)).

Open Code of Conduct from the [TODO Group](https://github.com/todogroup/opencodeofconduct/), [The Carpentries Code of Conduct](https://docs.carpentries.org/topic_folders/policies/index_coc.html) and [Contributor Covenant
